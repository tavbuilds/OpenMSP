    ...
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('vendor.name')->label(__('Vendor'))->searchable()->placeholder(__('—'))->visibleFrom('md'),
                TextColumn::make('sku')->label(__('SKU'))->searchable()->toggleable()->visibleFrom('xl'),
                TextColumn::make('type')->label(__('Type'))->badge()->visibleFrom('md'),
                ...
                TextColumn::make('margin_pct')
                    ...
                    ->visibleFrom('md'),
                TextColumn::make('billing_cycle')->label(__('Billing'))->badge()->visibleFrom('lg'),
